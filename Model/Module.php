...
namespace CSSoft\Core\Model;

use CSSoft\Core\Api\Data\ModuleInterface;

class Module extends \Magento\Framework\Model\AbstractModel implements ModuleInterface
{
    /**
     * @var \CSSoft\Core\Model\Module\LicenseValidatorFactory
     */
    protected $licenseValidatorFactory;

    /**
     * @var \CSSoft\Core\Model\Module\InstallerFactory
     */
    protected $installerFactory;

    /**
     * @var \CSSoft\Core\Model\Module\Installer
     */
    protected $installer;
     ...
     * @param \CSSoft\Core\Model\Module\LicenseValidator $licenseValidator
    ...
    public function __construct(
        ...
        \CSSoft\Core\Model\Module\LicenseValidatorFactory $licenseValidatorFactory,
        \CSSoft\Core\Model\Module\InstallerFactory $installerFactory,
        \Magento\Framework\Module\PackageInfo $packageInfo,
        \CSSoft\Core\Model\ComponentList\Loader\Remote $remoteComponents,
        \CSSoft\Core\Model\ComponentList\Loader\Local $localComponents,
    ...
    {
        $this->_init('CSSoft\Core\Model\ResourceModel\Module');
    }
